...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(560, 2, 245, 308))
        ...
        self.dimplesSpinBox = QtWidgets.QDoubleSpinBox(self.layoutWidget)
        self.dimplesSpinBox.setObjectName("dimplesSpinBox")
        self.horizontalLayout_5.addWidget(self.dimplesSpinBox)
        ...
        self.frame_2 = Canvas(self.centralwidget)
        self.frame_2.setGeometry(QtCore.QRect(1, 160, 550, 150))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 816, 15))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Dimples"))
        ...
        self.distanceField.setText(_translate("MainWindow", "TextLabel"))
        self.heightField.setText(_translate("MainWindow", "TextLabel"))
