...
clubs = {
    "Driver" : [6854, 10.9, 2686, .209, .412],  # .197, .084],  #     275, 32
    "3-wood" : [6485,  9.2, 3655, .258, .460],  # .247, .159],  #     243, 30
    "5-wood" : [6238,  9.4, 4350, .278, .461],  # .268, .187],  #     230, 31
    "3-iron" : [5828, 10.4, 4630, .280, .411],  # .270, .167],  #     212, 27
    "4-iron" : [5623, 11.0, 4836, .295, .450],  # .285, .200],  #     203, 28
    "5-iron" : [5417, 12.1, 5361, .315, .494],  # .306, .247],  #     194, 31
    "6-iron" : [5212, 14.1, 6231, .322, .395],  # .313, .195],  #     183, 30
    "7-iron" : [4925, 16.3, 7097, .333, .391],  # .325, .209],  #     172, 32 
    "8-iron" : [4720, 18.1, 7998, .349, .345],  # .341, .187],  #     160, 31  
    "9-iron" : [4473, 20.4, 8647, .360, .311],  # .352, .169],  #     148, 30
    "PWedge" : [4186, 24.2, 9304, .355, .239],  # .347, .124],  #     136, 29
}
