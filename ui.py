...
clubs = {
    ...
    "Driver" : [6854, 10.9, 2686, .232, .668, 113, -1.3, 8.55, 205, .830],  # .197, .084],  #     275, 32      loft should be 10    
    "3-wood" : [6485,  9.2, 3655, .265, .527, 107, -2.9, 12.33, 218, .830],  # .247, .159],  #     243, 30   loft should be 15
    "5-wood" : [6238,  9.4, 4350, .277, .449, 103, -3.3, 15.3, 234.5, .830],  # .268, .187],  #     230, 31  loft should be 19
    "3-iron" : [5828, 10.4, 4630, .275, .374,  98, -3.1, 17.18, 222.5, .830],  # .270, .167],  #     212, 27
    "4-iron" : [5623, 11.0, 4836, .290, .411,  96, -3.4, 18.35, 212, .830],  # .285, .200],  #     203, 28
    "5-iron" : [5417, 12.1, 5361, .309, .442,  94, -3.7, 20.89, 211, .830],  # .306, .247],  #     194, 31
    "6-iron" : [5212, 14.1, 6231, .313, .339,  92, -4.1, 25.05, 228.5, .830],  # .313, .195],  #     183, 30
    "7-iron" : [4925, 16.3, 7097, .324, .333,  90, -4.3, 29.54, 237.0, .830],  # .325, .209],  #     172, 32 
    "8-iron" : [4720, 18.1, 7998, .333, .263,  87, -4.5, 35.07, 345.0, .830],  # .341, .187],  #     160, 31  
    "9-iron" : [4473, 20.4, 8647, .347, .251,  85, -4.7, 39.48, 450.2, .830],  # .352, .169],  #     148, 30
    "PWedge" : [4186, 24.2, 9304, .360, .257,  83, -5.0, 44.5, 750.0, .830],  # .347, .124],  #     136, 29
}
